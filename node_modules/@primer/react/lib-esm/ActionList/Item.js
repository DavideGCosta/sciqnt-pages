...
const Item = /*#__PURE__*/React.forwardRef(({
  ...
  if (slots.trailingAction) {
    !!container ? process.env.NODE_ENV !== "production" ? invariant(false, `ActionList.TrailingAction can not be used within a ${container}.`) : invariant(false) : void 0;
  }
  ...
  }, inactiveText) : null, slots.blockDescription)), !inactive && Boolean(slots.trailingAction) && !container && slots.trailingAction));
});
