...
function ApacheFeatherVerticalIcon({
  title,
  titleId,
  size,
  colored,
  ...
  return /*#__PURE__*/React.createElement("svg", Object.assign({
    ...
    y1: 697.555,
    y2: 1395.619,
    gradientTransform: "rotate(-65.001 -1517.104 -5608.93)",
    ...
    fill: colored ? '#be202e' : (['#fff', '#fffff', 'white', '#FFF', '#FFFFFF'].includes('#be202e') ? 'white' : 'currentColor'),
    d: "M2496.187 1741.25s-.1 0-.1.1c-.1 0-.1.1-.2.1 2.6-.3 5.1-.8 7.6-1.1 10.3-1.5 20.4-3.3 30.2-5.4-12.3 2-24.8 4.2-37.5 6.3z"
  }), /*#__PURE__*/React.createElement("path", {
    fill: colored ? '#be202e' : (['#fff', '#fffff', 'white', '#FFF', '#FFFFFF'].includes('#be202e') ? 'white' : 'currentColor'),
    d: "M2496.187 1741.25s-.1 0-.1.1c-.1 0-.1.1-.2.1 2.6-.3 5.1-.8 7.6-1.1 10.3-1.5 20.4-3.3 30.2-5.4-12.3 2-24.8 4.2-37.5 6.3z",
    opacity: 0.35
    ...
    fill: "url(#b)",
    d: "M2318.287 1153.35c36.7-68.6 73.9-135.7 111.5-201 39-67.8 78.5-133.6 118.4-197 2.3-3.7 4.7-7.5 7-11.3 39.4-62.4 79.2-122.4 119.3-179.8l-120.8-228c-9.1 11.1-18.2 22.4-27.5 33.9-34.8 43.4-71 90.1-108.1 139.6-41.8 55.8-84.8 115.4-128.5 177.9-40.3 57.8-81.2 118.3-122.1 180.9-34.8 53.3-69.8 108.2-104.5 164.5l-3.9 6.3 157.2 310.5c33.6-66.5 67.6-132.1 102-196.5z"
  }), /*#__PURE__*/React.createElement("linearGradient", {
    id: "c",
    x1: -9071.207,
    x2: -6533.178,
    ...
    fill: "url(#e)",
    d: "M1418.687 2534.95c-19.8 99.8-33.9 199.2-41 298-.2 3.5-.6 6.9-.8 10.4-49.3-79-181.3-156.1-181-155.4 94.5 137 166.2 273 176.9 406.5-50.6 10.4-119.9-4.6-200-34.1 83.5 76.7 146.2 97.9 170.6 103.6-76.7 4.8-156.6 57.5-237.1 118.2 117.7-48 212.8-67 280.9-51.6-108 305.8-216.3 643.4-324.6 1001.8 33.2-9.8 53-32.1 64.1-62.3 19.3-64.9 147.4-490.7 348.1-1050.4 5.7-15.9 11.5-31.9 17.3-48 1.6-4.5 3.3-9 4.9-13.4 21.2-58.7 43.2-118.6 65.9-179.7 5.2-13.9 10.4-27.8 15.6-41.8.1-.3.2-.6.3-.8l-157.8-311.8c-.7 3.5-1.6 7.1-2.3 10.8z"
  }), /*#__PURE__*/React.createElement("linearGradient", {
    id: "f",
    x1: -9346.126,
    x2: -5086.994,
    ...
    fill: colored ? '#be202e' : (['#fff', '#fffff', 'white', '#FFF', '#FFFFFF'].includes('#be202e') ? 'white' : 'currentColor'),
    d: "M2495.787 1741.45c2.6-.3 5.1-.8 7.6-1.1-2.5.3-5 .7-7.6 1.1z"
  }), /*#__PURE__*/React.createElement("path", {
    fill: colored ? '#be202e' : (['#fff', '#fffff', 'white', '#FFF', '#FFFFFF'].includes('#be202e') ? 'white' : 'currentColor'),
    d: "M2495.787 1741.45c2.6-.3 5.1-.8 7.6-1.1-2.5.3-5 .7-7.6 1.1z",
    opacity: 0.35
    ...
    fill: colored ? '#be202e' : (['#fff', '#fffff', 'white', '#FFF', '#FFFFFF'].includes('#be202e') ? 'white' : 'currentColor'),
    d: "M2496.087 1741.35s.1 0 .1-.1c0 0-.1 0-.1.1z"
  }), /*#__PURE__*/React.createElement("path", {
    fill: colored ? '#be202e' : (['#fff', '#fffff', 'white', '#FFF', '#FFFFFF'].includes('#be202e') ? 'white' : 'currentColor'),
    d: "M2496.087 1741.35s.1 0 .1-.1c0 0-.1 0-.1.1z",
    opacity: 0.35
    ...
    d: "M3281.287 392.75v11.7h27.4v77.4h12.7v-77.4h27.6v-11.7zm158.3 0l-30.6 62.2-30.8-62.2h-15.3v89.1h11.7v-70.7l30.3 61.3h8.1l30.3-61.3v70.7h11.7v-89.1z"
  }));
}
const ForwardRef = React.forwardRef(ApacheFeatherVerticalIcon);
