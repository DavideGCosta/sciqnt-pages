...
function JupyterHubIcon({
  ...
  return /*#__PURE__*/React.createElement("svg", Object.assign({
    ...
    d: "M17.734 1.61A1.207 1.207 0 1116.477.478a1.193 1.193 0 011.257 1.132z"
  }), /*#__PURE__*/React.createElement("path", {
    fill: colored ? '#F37726' : (['#fff', '#fffff', 'white', '#FFF', '#FFFFFF'].includes('#F37726') ? 'white' : 'currentColor'),
    d: "M10.693 15.555c-3.205 0-6.021-1.15-7.478-2.848a7.973 7.973 0 0014.956 0c-1.453 1.698-4.259 2.848-7.478 2.848zM10.693 4.51c3.205 0 6.021 1.15 7.478 2.849a7.973 7.973 0 00-14.956 0c1.457-1.702 4.26-2.849 7.478-2.849z"
  }), /*#__PURE__*/React.createElement("path", {
    fill: colored ? '#9E9E9E' : (['#fff', '#fffff', 'white', '#FFF', '#FFFFFF'].includes('#9E9E9E') ? 'white' : 'currentColor'),
    d: "M6.281 18.86a1.52 1.52 0 11-1.584-1.424 1.505 1.505 0 011.584 1.425z"
  }), /*#__PURE__*/React.createElement("path", {
    fill: colored ? '#616262' : (['#fff', '#fffff', 'white', '#FFF', '#FFFFFF'].includes('#616262') ? 'white' : 'currentColor'),
    d: "M3.58 4.123a.876.876 0 11.85-.911.887.887 0 01-.85.911z"
...
const ForwardRef = React.forwardRef(JupyterHubIcon);
