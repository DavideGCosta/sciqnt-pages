...
function MsExcelIcon({
  ...
  return /*#__PURE__*/React.createElement("svg", Object.assign({
    ...
    fill: colored ? '#185c37' : (['#fff', '#fffff', 'white', '#FFF', '#FFFFFF'].includes('#185c37') ? 'white' : 'currentColor'),
    d: "M19.581 15.35L8.512 13.4v14.409A1.192 1.192 0 009.705 29h19.1A1.192 1.192 0 0030 27.809V22.5z"
  }), /*#__PURE__*/React.createElement("path", {
    fill: colored ? '#21a366' : (['#fff', '#fffff', 'white', '#FFF', '#FFFFFF'].includes('#21a366') ? 'white' : 'currentColor'),
    d: "M19.581 3H9.705a1.192 1.192 0 00-1.193 1.191V9.5L19.581 16l5.861 1.95L30 16V9.5z"
  }), /*#__PURE__*/React.createElement("path", {
    fill: colored ? '#107c41' : (['#fff', '#fffff', 'white', '#FFF', '#FFFFFF'].includes('#107c41') ? 'white' : 'currentColor'),
    ...
    fill: colored ? '#33c481' : (['#fff', '#fffff', 'white', '#FFF', '#FFFFFF'].includes('#33c481') ? 'white' : 'currentColor'),
    d: "M28.806 3h-9.225v6.5H30V4.191A1.192 1.192 0 0028.806 3"
  }), /*#__PURE__*/React.createElement("path", {
    fill: colored ? '#107c41' : (['#fff', '#fffff', 'white', '#FFF', '#FFFFFF'].includes('#107c41') ? 'white' : 'currentColor'),
    d: "M19.581 16H30v6.5H19.581z"
  }));
}
const ForwardRef = React.forwardRef(MsExcelIcon);
