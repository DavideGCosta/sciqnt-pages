...
function PythonIcon({
  ...
  return /*#__PURE__*/React.createElement("svg", Object.assign({
    ...
    fill: colored ? '#306998' : (['#fff', '#fffff', 'white', '#FFF', '#FFFFFF'].includes('#306998') ? 'white' : 'currentColor'),
    ...
    fill: colored ? '#ffd43b' : (['#fff', '#fffff', 'white', '#FFF', '#FFFFFF'].includes('#ffd43b') ? 'white' : 'currentColor'),
...
const ForwardRef = React.forwardRef(PythonIcon);
