...
function DatalayerDashboardIcon({
  title,
  titleId,
  size,
  colored,
  ...
  return /*#__PURE__*/React.createElement("svg", Object.assign({
    ...
    x: 15.237,
    y: 614.866,
    fill: colored ? '#c9ffff' : (['#fff', '#fffff', 'white', '#FFF', '#FFFFFF'].includes('#c9ffff') ? 'white' : 'currentColor'),
    fillOpacity: 1,
    stroke: "#0c8502",
    strokeDasharray: "none",
    strokeLinejoin: "round",
...
const ForwardRef = React.forwardRef(DatalayerDashboardIcon);
