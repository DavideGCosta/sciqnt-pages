...
function AwsS3BucketIcon({
  ...
  return /*#__PURE__*/React.createElement("svg", Object.assign({
    ...
    fill: colored ? '#146EB4' : (['#fff', '#fffff', 'white', '#FFF', '#FFFFFF'].includes('#146EB4') ? 'white' : 'currentColor'),
    fillRule: "evenodd",
...
const ForwardRef = React.forwardRef(AwsS3BucketIcon);
