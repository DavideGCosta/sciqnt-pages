...
function SlackIcon({
  ...
  return /*#__PURE__*/React.createElement("svg", Object.assign({
    ...
    fill: colored ? '#DFA22F' : (['#fff', '#fffff', 'white', '#FFF', '#FFFFFF'].includes('#DFA22F') ? 'white' : 'currentColor'),
    ...
    fill: colored ? '#3CB187' : (['#fff', '#fffff', 'white', '#FFF', '#FFFFFF'].includes('#3CB187') ? 'white' : 'currentColor'),
    ...
    fill: colored ? '#CE1E5B' : (['#fff', '#fffff', 'white', '#FFF', '#FFFFFF'].includes('#CE1E5B') ? 'white' : 'currentColor'),
    ...
    fill: colored ? '#392538' : (['#fff', '#fffff', 'white', '#FFF', '#FFFFFF'].includes('#392538') ? 'white' : 'currentColor'),
    d: "M82.508 217.27l43.347-14.084-14.086-43.352-43.35 14.09 14.089 43.347"
  }), /*#__PURE__*/React.createElement("path", {
    fill: colored ? '#BB242A' : (['#fff', '#fffff', 'white', '#FFF', '#FFFFFF'].includes('#BB242A') ? 'white' : 'currentColor'),
    d: "M173.847 187.591c16.388-5.323 31.62-10.273 43.348-14.084l-14.088-43.36-43.35 14.09 14.09 43.354"
  }), /*#__PURE__*/React.createElement("path", {
    fill: colored ? '#72C5CD' : (['#fff', '#fffff', 'white', '#FFF', '#FFFFFF'].includes('#72C5CD') ? 'white' : 'currentColor'),
    ...
    fill: colored ? '#248C73' : (['#fff', '#fffff', 'white', '#FFF', '#FFFFFF'].includes('#248C73') ? 'white' : 'currentColor'),
    ...
    fill: colored ? '#62803A' : (['#fff', '#fffff', 'white', '#FFF', '#FFFFFF'].includes('#62803A') ? 'white' : 'currentColor'),
    d: "M144.16 96.256l43.356-14.088a546179.21 546179.21 0 00-14.089-43.36L130.07 52.9l14.09 43.356"
  }));
}
const ForwardRef = React.forwardRef(SlackIcon);
