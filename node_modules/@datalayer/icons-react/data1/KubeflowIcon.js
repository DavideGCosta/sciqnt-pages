...
function KubeflowIcon({
  ...
  return /*#__PURE__*/React.createElement("svg", Object.assign({
    ...
    fill: colored ? '#4279f4' : (['#fff', '#fffff', 'white', '#FFF', '#FFFFFF'].includes('#4279f4') ? 'white' : 'currentColor'),
    d: "M95.9 62.15l4.1 102.1 73.75-94.12a6.79 6.79 0 019.6-1.11l46 36.92-15-65.61z"
  }), /*#__PURE__*/React.createElement("path", {
    fill: colored ? '#0028aa' : (['#fff', '#fffff', 'white', '#FFF', '#FFFFFF'].includes('#0028aa') ? 'white' : 'currentColor'),
    d: "M102.55 182.98h65.42l-40.17-32.23-25.25 32.23z"
  }), /*#__PURE__*/React.createElement("path", {
    fill: colored ? '#014bd1' : (['#fff', '#fffff', 'white', '#FFF', '#FFFFFF'].includes('#014bd1') ? 'white' : 'currentColor'),
    d: "M180.18 83.92l-44 56.14 46.88 37.61 44.47-55.76-47.35-37.99z"
  }), /*#__PURE__*/React.createElement("path", {
    fill: colored ? '#bedcff' : (['#fff', '#fffff', 'white', '#FFF', '#FFFFFF'].includes('#bedcff') ? 'white' : 'currentColor'),
    d: "M83.56 52.3l.01-.01 38.69-48.52-62.39 30.05-15.41 67.51 39.1-49.03z"
  }), /*#__PURE__*/React.createElement("path", {
    fill: colored ? '#6ca1ff' : (['#fff', '#fffff', 'white', '#FFF', '#FFFFFF'].includes('#6ca1ff') ? 'white' : 'currentColor'),
    d: "M45.32 122.05l41.44 51.96-3.95-98.98-37.49 47.02z"
  }), /*#__PURE__*/React.createElement("path", {
    fill: colored ? '#a1c3ff' : (['#fff', '#fffff', 'white', '#FFF', '#FFFFFF'].includes('#a1c3ff') ? 'white' : 'currentColor'),
    d: "M202.31 28.73L142.65 0l-37.13 46.56 96.79-17.83z"
  }), /*#__PURE__*/React.createElement("path", {
    fill: colored ? '#4279f4' : (['#fff', '#fffff', 'white', '#FFF', '#FFFFFF'].includes('#4279f4') ? 'white' : 'currentColor'),
    stroke: "#4279f4",
    strokeMiterlimit: 10,
...
const ForwardRef = React.forwardRef(KubeflowIcon);
