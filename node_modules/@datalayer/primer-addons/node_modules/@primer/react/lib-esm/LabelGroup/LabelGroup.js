...
const getOverlayWidth = (buttonClientRect, containerRef, overlayPaddingPx) => {
  ...
  return overlayPaddingPx + buttonClientRect.right - (((_containerRef$current = containerRef.current) === null || _containerRef$current === void 0 ? void 0 : (_containerRef$current2 = _containerRef$current.getBoundingClientRect()) === null || _containerRef$current2 === void 0 ? void 0 : _containerRef$current2.left) || 0);
};
const InlineToggle = ({
  collapseButtonRef,
...
const LabelGroup = ({
  ...
  const hideChildrenAfterIndex = React.useCallback(truncateAfter => {
    ...
    const containerChildren = ((_containerRef$current3 = containerRef.current) === null || _containerRef$current3 === void 0 ? void 0 : _containerRef$current3.children) || [];
  ...
  React.useEffect(() => {
    ...
    if (visibleChildCount === 'auto') {
      ...
      for (const item of ((_containerRef$current4 = containerRef.current) === null || _containerRef$current4 === void 0 ? void 0 : _containerRef$current4.children) || []) {
