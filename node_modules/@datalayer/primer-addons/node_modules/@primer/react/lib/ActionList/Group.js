...
const Group = ({
  ...
  }, title && !slots.groupHeading ? /*#__PURE__*/React__default.default.createElement(GroupHeading, {
    title: title,
    variant: variant,
...
const GroupHeading = ({
  ...
  process.env.NODE_ENV !== "production" ? warning.warning(listRole === undefined && children !== undefined && as === undefined, `You are setting a heading for a list, that requires a heading level. Please use 'as' prop to set a proper heading level.`) : void 0;
  const styles = {
    paddingY: '6px',
  ...
  return /*#__PURE__*/React__default.default.createElement(React__default.default.Fragment, null, listRole ? /*#__PURE__*/React__default.default.createElement(Box, _extends({
    sx: styles,
    role: "presentation",
    "aria-hidden": "true"
  }, props), /*#__PURE__*/React__default.default.createElement("span", {
    id: groupHeadingId
  }, title !== null && title !== void 0 ? title : children), auxiliaryText && /*#__PURE__*/React__default.default.createElement("span", null, auxiliaryText)) : /*#__PURE__*/React__default.default.createElement(React__default.default.Fragment, null, /*#__PURE__*/React__default.default.createElement(Heading, _extends({
    as: as || 'h3',
    id: groupHeadingId,
    sx: merge__default.default(styles, sx)
  }, props), title !== null && title !== void 0 ? title : children), auxiliaryText && /*#__PURE__*/React__default.default.createElement("span", null, auxiliaryText)));
};
