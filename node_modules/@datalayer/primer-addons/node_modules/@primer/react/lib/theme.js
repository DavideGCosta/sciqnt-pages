...
var index = require('./legacy-theme/ts/colors/index.js');
...
const fonts = {
  ...
  mono: theme$2.theme.fontStack(['var(--fontStack-monospace)', 'SFMono-Regular', 'Consolas', 'Liberation Mono', 'Menlo', 'Courier', 'monospace'])
};
const lineHeights = {
  condensedUltra: 1,
  condensed: 1.25,
...
const colorSchemes = Object.entries(index.colors).reduce((acc, [name, variables]) => {
  const {
    colors,
    shadows
