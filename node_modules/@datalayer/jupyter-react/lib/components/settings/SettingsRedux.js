...
/* Reducers */
export const settingsReducer = reducerWithInitialState(settingsInitialState).case(settingsActions.outputs, (state, success) => {
    return {
        ...state,
        outputs: success,
    };
});
//# sourceMappingURL=SettingsRedux.js.map