...
export const JupyterLabAppMinimumPlugins = {
    extensionPromises: [
        ...
        import('@jupyterlab/fileeditor-extension').then(plugins => plugins.default.filter(({ id }) => !(id.includes(':language-server') || id.includes(':search')))),
...
export const JupyterLabAppCorePlugins = (collaborative) => {
    return {
        extensionPromises: [
            import('@jupyterlab/application-extension'),
            import('@jupyterlab/apputils-extension'),
            ...
            import('@jupyterlab/filebrowser-extension').then(plugins => {
                if (collaborative) {
                    return plugins.default.filter(({ id }) => !(id.includes(':default-file-browser') // For RTC.
                    ));
                }
                else {
            ...
            import('@jupyterlab/markdownviewer-extension'),
            import('@jupyterlab/markedparser-extension'),
            import('@jupyterlab/fileeditor-extension').then(plugins => plugins.default.filter(({ id }) => !(
            //        id.includes(':search') ||
...
//# sourceMappingURL=JupyterLabAppPlugins.js.map