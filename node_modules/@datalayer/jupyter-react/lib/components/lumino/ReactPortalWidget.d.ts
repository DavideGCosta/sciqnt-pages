 ...
 */
export declare abstract class ReactPortalWidget extends Widget {
    /**
 ...
 */
export declare abstract class VDomRenderer<T extends VDomRenderer.IModel | null = null> extends ReactPortalWidget {
    /**
