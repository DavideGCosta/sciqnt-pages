...
export const CellSidebarSource = (props) => {
            ...
            '& p': {
                marginBottom: '0 !important',
                        ...
                        dispatch(notebookActions.insertAbove.started({
                            uid: notebookId,
                            cellType: 'code',
                            source: "print('Hello 🪐 ⚛️ Jupyter React, I have been inserted up ⬆️.')",
                        }));
                    }, children: "Code (with source)" }) }), _jsx("span", { style: { display: 'flex' }, children: _jsx(Button, { leadingVisual: ChevronUpIcon, variant: "invisible", size: "small", onClick: (e) => {
                        e.preventDefault();
                        dispatch(notebookActions.insertAbove.started({
                            uid: notebookId,
                            cellType: 'markdown',
                        }));
                    }, children: "Markdown" }) }), _jsx("span", { style: { display: 'flex' }, children: activeCell.model.type === 'code' ? (_jsx(Button, { leadingVisual: SquareIcon, variant: "invisible", size: "small", onClick: (e) => {
                        e.preventDefault();
                        dispatch(notebookActions.changeCellType.started({
                            uid: notebookId,
                            cellType: 'markdown',
                        }));
                    }, children: "To Markdown" })) : (_jsx(Button, { leadingVisual: SquareIcon, variant: "invisible", size: "small", onClick: (e) => {
                        e.preventDefault();
                        dispatch(notebookActions.changeCellType.started({
                            uid: notebookId,
                            cellType: 'code',
                        ...
                        dispatch(notebookActions.insertBelow.started({
                            uid: notebookId,
                            cellType: 'code',
                            source: "print('Hello 🪐 ⚛️ Jupyter React, I have been inserted down ⬇️.')",
                        }));
                    }, children: "Code (with source)" }) }), _jsx("span", { style: { display: 'flex' }, children: _jsx(Button, { leadingVisual: XIcon, variant: "invisible", size: "small", onClick: (e) => {
                        e.preventDefault();
...
//# sourceMappingURL=CellSidebarSource.js.map