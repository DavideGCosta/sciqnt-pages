 ...
 */
export const JupyterLabCss = (props) => {
    ...
    useEffect(() => {
        ...
        theme?.then(module => {
            if (module.default) {
                document.body.insertAdjacentHTML('afterbegin', `<style ${DATASET_LAB_THEME}="${colorMode}">
${module.default}
</style>`);
            }
        });
    }, [colorMode]);
    return _jsx("div", { id: "dla-JupyterLabCss-id" });
};
JupyterLabCss.defaultProps = {
    colorMode: 'light',
};
export default JupyterLabCss;
//# sourceMappingURL=JupyterLabCss.js.map